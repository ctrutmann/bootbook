class AddColumnsToUsers < ActiveRecord::Migration[5.0]
  def change
    ...
    add_column :users, :advice_to_students, :string
    add_column :users, :advice_to_graduates, :string
    ...
    # data information
    add_column :users, :female_scholarship, :string
    add_column :users, :poc_scholarship, :string
    add_column :users, :lgbtq_scholarship, :string
    add_column :users, :veteran_scholarship, :string
